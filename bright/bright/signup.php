...
<div class="row">
<div class="col-md-12">
<h1>signup <strong>News</strong></h1>
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-6">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input id="form_email1" type="text" name="username" class="form-control" placeholder="Please select your userid *" required="required" data-error="Valid email is required.">
