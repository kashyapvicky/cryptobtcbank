                    ...
                    <div class="col-md-12">
                        ...
                        <table class="table table-striped table-hover table-full-width table-bordered" id="">
                            ...
                            <thead class="table-bordered">
                                ...
                                $sql = "SELECT `transfer_date`,`user_id_credit`,`user_id_debit`,`remark` FROM pin_wallet WHERE user_id_credit = '$username' OR user_id_debit = '$username'";          

                                $result = mysqli_query($s_dbid,$sql);

                            while(list($transfer_date,$user_id_credit,$user_id_debit,$remarks) = mysqli_fetch_row($result)){
                                ...
                                ?>                                        
                                    ...
                                    <tr class="tr2">
                                        ...
                                        <td><?php if(strcasecmp($username, $user_id_credit) == 0){echo "<span class='label label-success'>Credit</span>";} else{echo "<span class='label label-danger'>Debit</span>";} ?></td>

                                        <td><?=$transfer_date?></td>

                                        <td><?=$user_id_debit?></td>

										<td><?=$user_id_credit?></td>
