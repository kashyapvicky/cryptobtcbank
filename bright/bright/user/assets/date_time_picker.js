...
var imagePath=$("#img_src_path").val();
imagePath=imagePath+"images/";
  ...
  function selectTime(ctl,ctl2) {
    ...
    textCtl=ctl2;
    currentCtl = ctl
    currentCtl.src=imagePath + "timepicker2.jpg";
  ...
  function closeTimePicker() {
    ...
    showElement( 'SELECT' );
    showElement( 'APPLET' );
    currentCtl.src=imagePath + "timepicker.jpg"
  }

  $('.time-picker').onkeypress = function hideTimePicker1 () { 
    if (event.keyCode==27){
      if (!bShow){
        closeTimePicker();
      }
