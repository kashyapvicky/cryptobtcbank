                    ...
                    <div class="col-md-12">
                        ...
                        <table class="table table-striped table-hover table-full-width table-bordered" id="">
                            <thead class="table-bordered">
                                ...
                                <?php 
                                $ctr=1;
                                $sql = "select `ttime`,`remarks`,`comm`,`amt`,`rname` from `inv_transactions` where `mid` = '$mid' and `remarks` = 'Direct Sales Bonus';";           
                                $result = mysqli_query($s_dbid,$sql);
                                while(list($idate,$remarks,$amount,$pamt,$rname) = mysqli_fetch_row($result)){
