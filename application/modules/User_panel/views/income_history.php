    ...
    <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Credit Income</h6>
            ...
            <table id="datatable1" class="table display responsive nowrap">
              <thead>
                <tr>
                  ...
                  <th class="wd-15p">Amount Credit</th>
              ...
              <tbody>
                ...
                $sr = 1;
                  ...
                  {
                    // print_r($income_detail); die;
                    if($value['income_type']==1)
                    {
                      $flag = "Matching Income";
                    }
                    elseif($value['income_type']==2)
                    {
                      $flag = "Direct Refferal";
                    }
                    else
                    {
                      $flag = 'ROI';
